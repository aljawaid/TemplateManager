                    ...
                    <div class="global-template-content">
                        <fieldset id="TemplateView-<?= $template['id'] ?>" class="template-view">
                            ...
                            <fieldset class="template-view-description">
                                <legend align="right" id="GlobalTemplateCopy<?= $template['id'] ?>" class="copy-global-template" data-clipboard-text="<?= htmlspecialchars($template['description']) ?>" title="<?= t('Copy to clipboard') ?>">
