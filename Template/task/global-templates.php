...
<details class="accordion-section">
    ...
    <?php foreach ($saved_global_templates as $template): ?>
        <details class="accordion-section subsection">
            <summary class="accordion-title acc-templates-section-title"><?= $this->text->e($template['title']) ?></summary>
            <div class="acc-templates-subsection-block acc-templates-subsection-manager">
