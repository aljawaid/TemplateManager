...
<form method="post" action="<?= $this->url->href('CommentTemplateController', 'update', array('project_id' => $project['id'], 'id' => $template['id'], 'plugin' => 'TemplateManager')) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
